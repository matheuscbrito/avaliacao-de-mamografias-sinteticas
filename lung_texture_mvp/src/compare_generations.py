...
def main() -> None:
    ...
    write_csv(args.output_dir / "per_case.csv", serializable)
    write_csv(args.output_dir / "rejected_or_invalid.csv", rejected)
    ...
    save_contact_sheet(better_dsr, args.output_dir / "visual_dsr_favored.png", "Casos em que Dsr preserva melhor o contraste GLCM")
    save_contact_sheet(worse_dsr, args.output_dir / "visual_dgen_favored.png", "Casos em que Dgen preserva melhor o contraste GLCM")
    summary = {
