...
Os resultados ficam em reports/legacy/dgen_eda/:
...
O script só lê o dataset e escreve dentro de reports/legacy/dgen_eda/; nunca altera os
...
OUTPUT = Path("reports/legacy/dgen_eda")
